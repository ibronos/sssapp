...
const RegisterAdmin: React.FC = () => {
  ...
  const handleSubmit = async (e: SyntheticEvent) => {
    ...
    try {
        await axios.post(`${import.meta.env.VITE_SERVER_HOST}/registeradmin`, data)
        .then(() => {
            alert('data updated!');
        })
        .catch((error) => {
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit} >
                ...
                <button className="hidden flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
